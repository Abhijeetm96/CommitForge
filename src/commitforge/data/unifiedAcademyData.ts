...
export const ACADEMY_18_TOPICS: AcademyTopic[] = [
  ...
  },
  {
    ...
    description: 'Automated continuous integration, matrix testing, dependency caching, keyless OIDC auth, reusable workflows, and GitOps delivery.',
    iconName: 'PlayCircle',
    conceptCount: 8,
    concepts: [
      { id: 'c-actions-intro', command: '.github/workflows', title: 'GitHub Actions Basics & Triggers', shortDesc: 'YAML workflows, triggers, runners, and steps', difficulty: 'Intermediate' },
      { id: 'c-ci-cd-pipelines', command: 'actions CI', title: 'Automated CI Pipelines & Test Runners', shortDesc: 'Build, lint, test, and job dependencies (needs: [])', difficulty: 'Intermediate' },
      { id: 'c-actions-matrix', command: 'strategy.matrix', title: 'Matrix Builds & Multi-OS Strategies', shortDesc: 'Parallel cross-platform and multi-version testing', difficulty: 'Intermediate' },
      { id: 'c-actions-caching', command: 'actions/cache', title: 'Dependency Caching & Build Artifacts', shortDesc: 'High-speed package caching and artifact retention', difficulty: 'Intermediate' },
      { id: 'c-action-secrets', command: 'secrets & OIDC', title: 'Encrypted Secrets, Environments & Keyless OIDC', shortDesc: 'Protected environments and AWS/GCP keyless auth', difficulty: 'Advanced' },
      { id: 'c-actions-reusable', command: 'workflow_call', title: 'Reusable Workflows & Custom Actions', shortDesc: 'Composite actions and centralized workflow templates', difficulty: 'Advanced' },
      { id: 'c-releases-artifacts', command: 'releases & GHCR', title: 'Automated Releases & Container Publishing', shortDesc: 'Semantic releases, changelogs, and package registry', difficulty: 'Intermediate' },
      { id: 'c-actions-gitops', command: 'runners & GitOps', title: 'Self-Hosted Runners & GitOps Continuous Delivery', shortDesc: 'ARC autoscaling, canary rollouts, and ArgoCD delivery', difficulty: 'Expert' },
    ],
  },
  {
    id: 'topic-16',
