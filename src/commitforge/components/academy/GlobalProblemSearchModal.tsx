              ...
              {matchingConcepts.length > 0 && (
                <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                  ...
                  {matchingConcepts.map((c) => {
                    const isCiCd = c.topicId === 'topic-15';
                    return (
                      <div
                        key={c.id}
                        onClick={() => {
                        ...
                        style={{
                          ...
                          borderRadius: '8px',
                          background: isCiCd ? 'rgba(139, 92, 246, 0.1)' : 'var(--bg-card)',
                          border: isCiCd ? '1px solid rgba(139, 92, 246, 0.38)' : '1px solid var(--border-color)',
                          cursor: 'pointer',
                          display: 'flex',
                          alignItems: 'center',
                      ...
                      >
                        <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
                          {isCiCd ? <Zap size={16} color="#a855f7" /> : <Terminal size={16} color="#38bdf8" />}
                          <div style={{ display: 'flex', alignItems: 'center', flexWrap: 'wrap', gap: '0.35rem' }}>
                            <span style={{ fontFamily: 'ui-monospace, monospace', fontWeight: 700, color: isCiCd ? '#e9d5ff' : 'var(--text-primary)', fontSize: '0.86rem' }}>
                              {c.command}
                            </span>
                            <span style={{ fontSize: '0.78rem', color: isCiCd ? '#cbd5e1' : 'var(--text-secondary)' }}>
                              {c.title}
                            </span>
                            {isCiCd && (
                              <span
                        ...
                        <span style={{ fontSize: '0.72rem', color: isCiCd ? '#c084fc' : 'var(--text-muted)', fontWeight: isCiCd ? 700 : 400 }}>
                          {c.topicTitle} →
                        </span>
                      </div>
                    );
