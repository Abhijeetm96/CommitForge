...
export function getConceptIcon(
  ...
  if (conceptId) {
    switch (conceptId) {
      ...
      case 'c-actions-matrix': return <Sliders {...iconProps} />;
      case 'c-actions-caching': return <Zap {...iconProps} />;
      case 'c-action-secrets': return <Lock {...iconProps} />;
      case 'c-actions-reusable': return <Workflow {...iconProps} />;
      case 'c-releases-artifacts': return <Package {...iconProps} />;
      case 'c-actions-gitops': return <Boxes {...iconProps} />;
